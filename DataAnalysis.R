...
#ANOSIM
ano = anosim(otu_m, sampdf$Day, distance = "euclidean", permutations = 9999)
ano_d1 = anosim(stat_d1, sampdf_d1$Site, distance = "euclidean", permutations = 9999)
ano_d2 = anosim(stat_d2, sampdf_d2$Site, distance = "euclidean", permutations = 9999)
